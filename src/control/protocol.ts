...
export type AgentApprovalRequest =
  | { readonly protocol: "ghostget.approval/1"; readonly action: "request"; readonly id: string; readonly target: ApprovalTarget; readonly expectedDigest: string; readonly use?: string }
