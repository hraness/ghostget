...
const snapshot = object({
  ...
  accounts: list(object({ id: text, provider: nullable(text), kind: text, subject: nullable(text), revision: text, status: oneOf("configured", "verified", "reconnect-required"), source: nullable(text), tokenStorage: nullable(oneOf("external", "ghostget-import", "managed-oauth")) })),
