...
const linkedin = {
  ...
  "contacts.read": contract(
    ...
    "reviewed contained-Chrome 1st-degree Contact-info read: bind the signed-in viewer, require a 1st-degree relationship on the requested vanity from Profile embeds or Como rehydration, then project embedded Contact-info fields while skipping non-bounded SDUI labels, or POST ProfileContactDetailsOverlay using that screenId as sduiid with proto.sdui types and nested requestMetadata; treat an HTML-200 shell that omits Email as omitted fields, keep navigation GETs rejected, and do not invent Email",
