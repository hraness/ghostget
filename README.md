...
```sh
bun add --global https://github.com/hraness/ghostget/releases/download/v0.18.19/hraness-ghostget-0.18.19.tgz
...
```sh
npx skills add hraness/ghostget#v0.18.19
# With Bun instead:
bunx skills add hraness/ghostget#v0.18.19
```
...
This v0.18.19 source tree supports executable actions for 20 services: Beeper,
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.18.19/hraness-ghostget-0.18.19.tgz
```
