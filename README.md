...
This v0.17.0 source tree supports executable actions for 20 services: Beeper,
...
verified public, `@hraness/ghostget@0.17.0` is also available from the registry.
...
```sh
npx skills add hraness/ghostget#v0.17.0
# or
bunx skills add hraness/ghostget#v0.17.0
```
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.17.0/hraness-ghostget-0.17.0.tgz
```
