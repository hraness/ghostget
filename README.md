...
```sh
bun add --global https://github.com/hraness/ghostget/releases/download/v0.18.31/hraness-ghostget-0.18.31.tgz
...
```sh
npx skills add hraness/ghostget#v0.18.31
# With Bun instead:
bunx skills add hraness/ghostget#v0.18.31
```
...
This v0.18.31 source tree supports executable actions for 21 services: Beeper,
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.18.31/hraness-ghostget-0.18.31.tgz
```
