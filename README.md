...
```sh
bun add --global https://github.com/hraness/ghostget/releases/download/v0.18.22/hraness-ghostget-0.18.22.tgz
...
```sh
npx skills add hraness/ghostget#v0.18.22
# With Bun instead:
bunx skills add hraness/ghostget#v0.18.22
```
...
This v0.18.22 source tree supports executable actions for 20 services: Beeper,
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.18.22/hraness-ghostget-0.18.22.tgz
```
