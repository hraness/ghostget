...
```sh
npx skills add hraness/ghostget#v0.18.26
# With Bun instead:
bunx skills add hraness/ghostget#v0.18.26
```
...
This v0.18.26 source tree supports executable actions for 20 services: Beeper,
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.18.26/hraness-ghostget-0.18.26.tgz
```
