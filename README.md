...
This v0.16.17 source tree supports executable actions for 20 services: Beeper,
...
verified public, `@hraness/wrench@0.16.17` is also available from the registry.
...
```sh
npx skills add hraness/wrench#v0.16.17
# or
bunx skills add hraness/wrench#v0.16.17
```
...
can execute. A source-owned bundled manifest from an incompatible Wrench
