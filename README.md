...
```sh
npx skills add hraness/ghostget#v0.18.25
# With Bun instead:
bunx skills add hraness/ghostget#v0.18.25
```
...
This v0.18.25 source tree supports executable actions for 20 services: Beeper,
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.18.25/hraness-ghostget-0.18.25.tgz
```
