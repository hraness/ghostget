...
This v0.16.16 source tree supports executable actions for 20 services: Beeper,
...
verified public, `@hraness/wrench@0.16.16` is also available from the registry.
...
```sh
npx skills add hraness/wrench#v0.16.16
# or
bunx skills add hraness/wrench#v0.16.16
```
