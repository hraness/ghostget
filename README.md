...
This v0.17.4 source tree supports executable actions for 20 services: Beeper,
...
verified public, `@hraness/ghostget@0.17.4` is also available from the registry.
...
```sh
npx skills add hraness/ghostget#v0.17.4
# or
bunx skills add hraness/ghostget#v0.17.4
```
...
```sh
bun add https://github.com/hraness/ghostget/releases/download/v0.17.4/hraness-ghostget-0.17.4.tgz
```
