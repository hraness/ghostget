...
const output = resolve(root, "build/menubar/ghostget-menubar");
...
const result = Bun.spawnSync([
  "/usr/bin/xcrun", "swiftc", "-O", "-parse-as-library", "-framework", "AppKit",
  resolve(root, "menubar/Outputs.swift"), resolve(root, "menubar/ghostget-menubar.swift"), "-o", output,
