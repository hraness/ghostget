...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(23_089_664);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(budget).toContain("22,517,432 payload bytes across exactly 558 files");
    expect(budget).toContain("4364e327fe827e8ab5acd1046ffcee8754b82c8160a6e94051b1e7a04d477752");
    ...
    expect(MAX_UNPACKED_BYTES).toBe(22_517_497);
    expect(MAX_UNPACKED_BYTES).toBe(22_517_432 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      unpackedBytes: { min: 9_000_000, max: 22_517_497 },
    });
  });
