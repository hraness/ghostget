...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(24_224_256);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      ...
      packedBytes: 12_054_165, unpackedBytes: 23_606_871, entryCount: 602,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(12_070_648);
    expect(MAX_PACKED_BYTES).toBe(12_054_165 + 12_387 + 4_096);
    expect(budget).toContain("9944c75705bf31ec5448fcb27dd48626038bd7fa10efc54bc205f651cc2837ee");
    expect(budget).toContain("a3255fabc42549339f0d600e40b3769750eab951b551f453489ffa00a9e69b45");
    ...
    expect(MAX_PACKED_ENTRIES).toBe(602);
    expect(MAX_PACKED_FILES).toBe(602);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_607_289);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_606_871 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 12_070_648 },
      unpackedBytes: { min: 9_000_000, max: 23_607_289 },
    });
  });
