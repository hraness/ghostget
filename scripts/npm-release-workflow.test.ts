...
describe("npm publication contract", () => {
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      ...
      packedBytes: 11_992_931, unpackedBytes: 23_425_226, entryCount: 596,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(12_009_414);
    expect(MAX_PACKED_BYTES).toBe(11_992_931 + 12_387 + 4_096);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_425_644);
    expect(budget).toContain("23,424,993 + 353 + 65 = 23,425,411");
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_425_226 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 12_009_414 },
      unpackedBytes: { min: 9_000_000, max: 23_425_644 },
    });
  });
