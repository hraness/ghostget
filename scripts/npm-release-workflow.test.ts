...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(23_080_448);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(budget).toContain("22,508,497 payload bytes across exactly 558 files");
    expect(budget).toContain("170dac25ba3eaa4176d604a103a08dd4dff424feaf23454ad407f4524ffe0d99");
    ...
    expect(MAX_UNPACKED_BYTES).toBe(22_508_562);
    expect(MAX_UNPACKED_BYTES).toBe(22_508_497 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      unpackedBytes: { min: 9_000_000, max: 22_508_562 },
    });
  });
