...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(23_785_984);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(budget).toContain("23,182,612 + 353 + 65 = 23,183,030");
    expect(budget).toContain("6b0afd720195e1103c8819176a7c189e56267a8bd1be76a3d1cde67b27332595");
    expect(MAX_UNPACKED_BYTES).toBe(23_183_030);
    expect(budget).toContain("22,689,627 + 10 = 22,689,637");
    expect(budget).toContain("22,689,627 + 65 = 22,689,692");
    expect(MAX_UNPACKED_BYTES).toBe(23_182_965 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      unpackedBytes: { min: 9_000_000, max: 23_183_030 },
    });
  });
