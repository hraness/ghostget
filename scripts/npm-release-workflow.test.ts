...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(23_796_736);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(MAX_PACKED_BYTES).toBe(11_946_837);
    expect(MAX_PACKED_BYTES).toBe(11_942_741 + 4_096);
    expect(budget).toContain("11,942,741 + 4,096 = 11,946,837");
    ...
    expect(budget).toContain("23,193,728 + 353 + 65 = 23,194,146");
    expect(budget).toContain("47684b3e2eb5cf3ed07fbb520aade8c7251d993f75262fbf1af627d9081a1a5f");
    expect(MAX_UNPACKED_BYTES).toBe(23_194_146);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_194_081 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 11_946_837 },
      unpackedBytes: { min: 9_000_000, max: 23_194_146 },
    });
  });
