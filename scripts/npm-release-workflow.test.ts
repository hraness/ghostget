...
describe("npm publication contract", () => {
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      ...
      packedBytes: 11_983_933, unpackedBytes: 23_342_196, entryCount: 596,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(12_000_416);
    expect(MAX_PACKED_BYTES).toBe(11_983_933 + 12_387 + 4_096);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_342_614);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_342_196 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 12_000_416 },
      unpackedBytes: { min: 9_000_000, max: 23_342_614 },
    });
  });
