...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(24_038_400);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      archiveSha256: "49912b55cff4e3250c757606789922ea8940d5f731acf184f58ba4e952fd9db4",
      packedBytes: 11_993_478, unpackedBytes: 23_427_051, entryCount: 596,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(12_009_961);
    expect(MAX_PACKED_BYTES).toBe(11_993_478 + 12_387 + 4_096);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_427_469);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_427_051 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 12_009_961 },
      unpackedBytes: { min: 9_000_000, max: 23_427_469 },
    });
  });
