...
describe("npm publication contract", () => {
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      ...
      packedBytes: 11_971_987, unpackedBytes: 23_343_331, entryCount: 596,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(11_988_470);
    expect(MAX_PACKED_BYTES).toBe(11_971_987 + 12_387 + 4_096);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_343_749);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_343_331 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 11_988_470 },
      unpackedBytes: { min: 9_000_000, max: 23_343_749 },
    });
  });
