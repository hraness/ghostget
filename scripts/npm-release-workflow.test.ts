...
describe("npm publication contract", () => {
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(repairPackageMeasurement).toMatchObject({
      ...
      packedBytes: 11_975_057, unpackedBytes: 23_353_842, entryCount: 596,
      packedPlatformProjection: 12_387, packedPortabilityAllowance: 4_096,
      payloadPlatformProjection: 353, payloadAllowance: 65,
    });
    expect(MAX_PACKED_BYTES).toBe(11_991_540);
    expect(MAX_PACKED_BYTES).toBe(11_975_057 + 12_387 + 4_096);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_354_260);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_353_842 + 353 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      ...
      packedBytes: { min: 1_600_000, max: 11_991_540 },
      unpackedBytes: { min: 9_000_000, max: 23_354_260 },
    });
  });
