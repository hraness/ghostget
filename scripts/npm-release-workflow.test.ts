...
describe("npm publication contract", () => {
  test("derives the tar expansion ceiling from the reviewed package budget", async () => {
    ...
    expect(MAX_PACKAGE_TAR_BYTES).toBe(23_834_112);
  ...
  test("keeps one narrow release-authoritative package budget", async () => {
    ...
    expect(MAX_PACKED_BYTES).toBe(11_961_581);
    expect(MAX_PACKED_BYTES).toBe(11_946_327 + 11_158 + 4_096);
    ...
    expect(MAX_PACKED_ENTRIES).toBe(589);
    expect(MAX_PACKED_FILES).toBe(589);
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_230_176);
    ...
    expect(budget).toContain("23,230,111 + 65 = 23,230,176");
    ...
    expect(MAX_UNPACKED_BYTES).toBe(23_230_111 + 65);
    ...
    expect(packageArtifactBudget).toEqual({
      entryCount: { min: 589, max: 589 },
      fileCount: { min: 589, max: 589 },
      packedBytes: { min: 1_600_000, max: 11_961_581 },
      unpackedBytes: { min: 9_000_000, max: 23_230_176 },
    });
  });
