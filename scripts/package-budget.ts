...
// This adds 637 payload bytes over the unchanged 596-file inventory. Two
// `npm pack --ignore-scripts` runs with npm 11.19.0 on darwin arm64 were
// byte-identical at 11,993,194 packed bytes, 23,425,630 unpacked bytes;
// archive SHA-256
// 44bd822a6adae16c26933a821b8f9e3663c5a618c8ff5281a017e1245e7792e6. Carry the
// same projections and allowances: 11,993,194 + 12,387 + 4,096 = 12,009,677
// packed; 23,425,630 + 353 + 65 = 23,426,048 unpacked.
export const repairPackageMeasurement = Object.freeze({
  ...
  packedBytes: 11_993_194,
  unpackedBytes: 23_425_630,
  entryCount: 596,
