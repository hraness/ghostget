...
async function installBundledMessagingRuntime(provider, environment = process.env) {
  ...
  try {
    ...
    if (provider === "imessage") {
      const { installReviewedImsgBinary } = await import("./imessage-direct-install-pegd9t44.js");
    ...
    const { installReviewedWhatsAppAutomationBinary } = await import("./whatsapp-automation-runtime-jxga22zp.js");
