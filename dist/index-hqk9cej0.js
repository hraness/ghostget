...
var GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_FORMAT = "wrench.messaging-context-binding";
var GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_ID = "wrench.messaging-context-binding.v2";
var GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_DESCRIPTOR = Object.freeze({
...
var GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_HASH = sha256(canonicalJson(GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_DESCRIPTOR));
var GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_FORMAT = "wrench.messaging-receipt-binding";
var GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_ID = "wrench.messaging-receipt-binding.v2";
var GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_DESCRIPTOR = Object.freeze({
...
var GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_HASH = sha256(canonicalJson(GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_DESCRIPTOR));
var GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_FORMAT = "wrench.messaging-client-intent-binding";
var GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_CONTRACT_ID = "wrench.messaging-client-intent-binding.v1";
var GHOSTGET_MESSAGING_CONTEXT_INSTANCE_V1_CONTRACT_ID = "wrench.messaging-context-instance.v1";
var GHOSTGET_MESSAGING_CONTEXT_INSTANCE_V2_CONTRACT_ID = "wrench.messaging-context-instance.v2";
...
function parseMessageLikeMeSourceConversationCoordinateBindingV1(value) {
  ...
  exactKeys(binding, ["contractId", "schemaVersion", "sha256"], "Ghostget source-conversation coordinate binding");
...
function parseGhostgetMessagingContextBindingV1(value) {
  ...
  if (context.schemaVersion !== 1 || context.format !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_FORMAT || context.contractId !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_ID || context.contractHash !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_HASH)
    return fail("Ghostget messaging context binding V1 has an unsupported contract identity");
  const validatedAt = legacyTimestamp(context.validatedAt, "Ghostget messaging context binding V1.validatedAt");
  const expiresAt = legacyTimestamp(context.expiresAt, "Ghostget messaging context binding V1.expiresAt");
  ...
  return Object.freeze({
    ...
    routeRef: text(context.routeRef, "Ghostget messaging context binding V1.routeRef", 2048),
    contextRef: text(context.contextRef, "Ghostget messaging context binding V1.contextRef", 2048),
    exactDataRevision: digest(context.exactDataRevision, "Ghostget messaging context binding V1.exactDataRevision"),
    latestMessageRevision: digest(context.latestMessageRevision, "Ghostget messaging context binding V1.latestMessageRevision"),
    validatedAt,
    expiresAt
  });
}
function parseGhostgetMessagingContextBindingV2(value) {
  ...
  if (context.schemaVersion !== 2 || context.format !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_FORMAT || context.contractId !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_ID || context.contractHash !== GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_HASH)
  ...
  return Object.freeze({
    ...
    routeRef: text(context.routeRef, "Ghostget messaging context binding.routeRef", 2048),
    contextRef: text(context.contextRef, "Ghostget messaging context binding.contextRef", 2048),
    exactDataRevision: digest(context.exactDataRevision, "Ghostget messaging context binding.exactDataRevision"),
    latestMessageRevision: digest(context.latestMessageRevision, "Ghostget messaging context binding.latestMessageRevision"),
    validatedAt,
    expiresAt
  });
}
function ghostgetMessagingContextBindingSha256V1(value) {
...
function ghostgetMessagingContextBindingSha256V2(value) {
...
function createBeeperMessageLikeMeSourceConversationCoordinateBindingV1(input) {
  ...
  exactKeys(read, ["provider", "operation", "accountSubject", "conversation"], "Ghostget Beeper exact conversation read");
  ...
  const expectedAccountSubject = text(input.expectedAccountSubject, "Ghostget Beeper expected account subject");
  if (text(read.accountSubject, "Ghostget Beeper exact conversation read.accountSubject") !== expectedAccountSubject)
    return fail("Ghostget Beeper exact conversation read did not bind the expected account subject");
  const conversation = plainObject(read.conversation, "Ghostget Beeper exact conversation read.conversation");
  exactKeys(conversation, BEEPER_EXACT_CONVERSATION_KEYS, "Ghostget Beeper exact conversation read.conversation");
  ...
  const accountId = text(conversation.accountId, "Ghostget Beeper exact conversation read.conversation.accountId");
  return messageLikeMeSourceConversationCoordinateBindingV1({
    sourceAccountId: accountId,
    sourceExternalId: accountId,
    coordinate: {
      kind: "beeperConversation",
      network: text(conversation.network, "Ghostget Beeper exact conversation read.conversation.network", 512),
      conversationId: text(conversation.id, "Ghostget Beeper exact conversation read.conversation.id")
    }
  });
}
function createBeeperMessageLikeMeContextBindingV1(input) {
  ...
  return parseGhostgetMessagingContextBindingV1(Object.freeze({
    ...
    contractId: GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_ID,
    contractHash: GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_HASH,
    routeRef: text(input.routeRef, "Ghostget messaging context binding V1.routeRef", 2048),
    contextRef: text(input.contextRef, "Ghostget messaging context binding V1.contextRef", 2048),
    exactDataRevision: digest(input.exactDataRevision, "Ghostget messaging context binding V1.exactDataRevision"),
    latestMessageRevision: digest(input.latestMessageRevision, "Ghostget messaging context binding V1.latestMessageRevision"),
...
function createBeeperMessageLikeMeContextBindingV2(input) {
  ...
  return parseGhostgetMessagingContextBindingV2(Object.freeze({
    ...
    contractHash: GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_HASH,
    sourceConversationCoordinate,
    routeRef: text(input.routeRef, "Ghostget messaging context binding.routeRef", 2048),
    contextRef: text(input.contextRef, "Ghostget messaging context binding.contextRef", 2048),
    exactDataRevision: digest(input.exactDataRevision, "Ghostget messaging context binding.exactDataRevision"),
    latestMessageRevision: digest(input.latestMessageRevision, "Ghostget messaging context binding.latestMessageRevision"),
    validatedAt: input.validatedAt,
    expiresAt: input.expiresAt
  }));
}
function parseGhostgetMessagingClientIntentBindingV1(value, contextValue) {
  ...
  if (intent.schemaVersion !== 1 || intent.format !== GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_FORMAT || intent.contractId !== GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_CONTRACT_ID)
  ...
  const parsed = Object.freeze({
    ...
    clientIntentSha256: digest(intent.clientIntentSha256, "Ghostget messaging client-intent binding.clientIntentSha256"),
    contextBindingSha256: digest(intent.contextBindingSha256, "Ghostget messaging client-intent binding.contextBindingSha256"),
    sourceConversationCoordinateSha256: digest(intent.sourceConversationCoordinateSha256, "Ghostget messaging client-intent binding.sourceConversationCoordinateSha256"),
    routeRefSha256: digest(intent.routeRefSha256, "Ghostget messaging client-intent binding.routeRefSha256"),
    contextRefSha256: digest(intent.contextRefSha256, "Ghostget messaging client-intent binding.contextRefSha256"),
...
function createGhostgetMessagingReceiptBindingV2(input) {
...
function createGhostgetMessagingReceiptBindingV1(input) {
...
export { MESSAGE_LIKE_ME_SOURCE_CONVERSATION_COORDINATE_V1_SCHEMA_VERSION, MESSAGE_LIKE_ME_SOURCE_CONVERSATION_COORDINATE_V1_CONTRACT_ID, GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_FORMAT, GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_ID, GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_DESCRIPTOR, GHOSTGET_MESSAGING_CONTEXT_BINDING_V1_CONTRACT_HASH, GHOSTGET_MESSAGING_RECEIPT_BINDING_V1_FORMAT, GHOSTGET_MESSAGING_RECEIPT_BINDING_V1_CONTRACT_ID, GHOSTGET_MESSAGING_RECEIPT_BINDING_V1_CONTRACT_DESCRIPTOR, GHOSTGET_MESSAGING_RECEIPT_BINDING_V1_CONTRACT_HASH, GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_FORMAT, GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_ID, GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_DESCRIPTOR, GHOSTGET_MESSAGING_CONTEXT_BINDING_V2_CONTRACT_HASH, GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_FORMAT, GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_ID, GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_DESCRIPTOR, GHOSTGET_MESSAGING_RECEIPT_BINDING_V2_CONTRACT_HASH, GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_FORMAT, GHOSTGET_MESSAGING_CLIENT_INTENT_BINDING_V1_CONTRACT_ID, GHOSTGET_MESSAGING_CONTEXT_INSTANCE_V1_CONTRACT_ID, GHOSTGET_MESSAGING_CONTEXT_INSTANCE_V2_CONTRACT_ID, parseMessageLikeMeSourceConversationCoordinateV1, messageLikeMeSourceConversationCoordinateBindingV1, parseMessageLikeMeSourceConversationCoordinateBindingV1, parseGhostgetMessagingContextBindingV1, parseGhostgetMessagingContextBindingV2, ghostgetMessagingContextBindingSha256V1, ghostgetMessagingContextBindingSha256V2, createBeeperMessageLikeMeSourceConversationCoordinateBindingV1, createBeeperMessageLikeMeContextBindingV1, createBeeperMessageLikeMeContextBindingV2, parseGhostgetMessagingClientIntentBindingV1, createGhostgetMessagingReceiptBindingV2, createGhostgetMessagingReceiptBindingV1 };
