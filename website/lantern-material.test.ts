...
test("retains the exact admitted asset-free Lantern CSS and attribution", async () => {
  ...
  expect(snapshot.manifest.source.commit).toBe("d38d13c07d7956d02ddfbca8d32aa2066d88fbd3");
...
test("keeps the Lantern wall on the homepage hero and preserves ordinary reading", async () => {
  ...
  expect(home.match(/class="hraness-marketing-question hraness-material-disclosure"/gu)).toHaveLength(16);
