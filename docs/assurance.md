...
The register holds 244 claims: 205 evidenced, 20 planned, and 19 not verified. It maps 90 guidelines from 5 guides; 70 list claims and 20 are exempt.

| Layer | Evidenced | Planned | Not verified |
| --- | ---: | ---: | ---: |
| example test | 146 | 1 | 0 |
| property test | 18 | 1 | 0 |
| stateful model | 13 | 10 | 0 |
| Quint model with production trace replay | 17 | 7 | 0 |
