...
- `src-tauri/` – the narrow Rust host used for local qualification; app bundling is disabled.
...
Native checks use the root-owned mac-native scheduler. Fixture browser
