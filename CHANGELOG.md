...
- Join LinkedIn `contacts.read@1` first-degree distance when identity comes from
  ...
  contradictory distances still fail closed, and no email is invented. Adapter
  bundle 1.25.0. This is the third live Contact-info drift after the 1.23.0
  flight-array parse and the 1.24.0 deep-walk / `vieweeProfileId` join.
