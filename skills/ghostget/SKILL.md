...
Ghostget supplies bounded CLI and SDK capabilities with a menu-bar companion for human control. Use it from the caller's own agent loop; Ghostget does not run a model.
