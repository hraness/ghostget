...
This reference is authored for the exact v0.18.37 release coordinate. Use it
...
The package is `@hraness/ghostget`; `@hraness/ghostget@0.18.37` is an optional npm
...
The [migration guide](https://github.com/hraness/ghostget/blob/v0.18.37/docs/ghostget-migration.md)
