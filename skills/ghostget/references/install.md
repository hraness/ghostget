...
This reference is authored for the exact v0.17.4 release coordinate. Use it
...
The package is `@hraness/ghostget`; `@hraness/ghostget@0.17.4` is an optional npm
...
The [migration guide](https://github.com/hraness/ghostget/blob/v0.17.4/docs/ghostget-migration.md)
