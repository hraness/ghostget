...
The package is `@hraness/ghostget`; `@hraness/ghostget@0.17.0` is an optional npm
...
The [migration guide](https://github.com/hraness/ghostget/blob/v0.17.0/docs/ghostget-migration.md)
