...
This reference is authored for the exact v0.19.0 release coordinate. Use it
...
The package is `@hraness/ghostget`; `@hraness/ghostget@0.19.0` is an optional npm
...
The [migration guide](https://github.com/hraness/ghostget/blob/v0.19.0/docs/ghostget-migration.md)
